...
```{r read_data, warning=FALSE, eval=FALSE, comment=NA}
library(readr)
...
```{R table_properties, results="hold", comment=NA, eval=FALSE}
...
```{R inspect_table_cols, comment=NA, eval=FALSE}
x <- gwas[["MAPPED_GENE"]]
print(head(x,n = 20))
```
...
```{R chromosome_inspect, comment=NA, eval=FALSE}
...
```{R summary_trait, comment=NA, eval=FALSE}
...
```{R trait_summary_plot, fig.height=7.5, fig.width=7.5, eval=FALSE}
library(ggplot2)
...
```{R trait_summary_plot2, fig.height=7.5, fig.width=7.5, eval=FALSE}
library(ggplot2)
...
```{R scatterplot_cd, warning=FALSE, eval=FALSE}
...
```{R scatterplot_ms, warning=FALSE, eval=FALSE}
...
```{R scatterplot_scz, warning=FALSE, eval=FALSE}
